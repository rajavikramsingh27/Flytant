...
//    MARK: - Properties
    ...
    var message: Message? {
        didSet{
            ...
            configurePartnerUser(userId: chatPartnerId)
...
//    MARK: - Views
    ...
    let messageImageView = FImageView(backgroundColor: UIColor.secondaryLabel, cornerRadius: 0, image: UIImage())
    
    let profileImageView = FImageView(backgroundColor: UIColor.secondaryLabel, cornerRadius: 16, image: UIImage())
    ...
    private func configurePartnerUser(userId: String){
