...
class MessageInputAccesoryView: UIView {
    ...
    let uploadImageIcon: UIImageView = {
        let iv = UIImageView()
        iv.image = UIImage(named: "imagePickerImage")
        return iv
    }()
    ...
    override init(frame: CGRect) {
        ...
        uploadImageIcon.anchor(top: topAnchor, left: leftAnchor, bottom: nil, right: nil, paddingTop: 8, paddingLeft: 8, paddingBottom: 0, paddingRight: 0, width: 36, height: 36)
