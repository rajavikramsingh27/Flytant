...
//    MARK: - Views
    ...
    private let backgroundImageView = FImageView(backgroundColor: UIColor.clear, cornerRadius: 0, image: UIImage(named: "postBackgroundImage")!)
...
//        navigationController?.navigationBar.setGradientBackground(colors: [UIColor(red:250/255, green:0/255, blue:102/255, alpha:1), UIColor(red:212/255, green:24/255, blue: 114/255, alpha:0.1), UIColor(red:148/255, green:0/255, blue: 211/255, alpha:0.1)], startPoint: .topLeft, endPoint: .topRight)
        ...
        navigationItem.leftBarButtonItem = UIBarButtonItem(image: UIImage(named: "uploadPost"), style: .done, target: self, action: #selector(handlePost))
        navigationItem.rightBarButtonItem = UIBarButtonItem(image: UIImage(named: "crossIcon"), style: .done, target: self, action: #selector(handleDiscard))
    }
    ...
    private func configureTextViewInputAccessoryView(){
        ...
        textViewInputAccessoryView.backgroundColor = UIColor.systemGray3
    ...
    private func configurePickButton(){
        ...
        pickButton.anchor(top: textViewInputAccessoryView.topAnchor, left: textViewInputAccessoryView.leftAnchor, bottom: nil, right: nil, paddingTop: 0, paddingLeft: 16, paddingBottom: 0, paddingRight: 0, width: 50, height: 50)
        pickButton.setImage(UIImage(named: "cameraAddIcon"), for: .normal)
    ...
    private func configureLocationButton(){
        ...
        locationButton.anchor(top: textViewInputAccessoryView.topAnchor, left: pickButton.rightAnchor, bottom: nil, right: nil, paddingTop: 4, paddingLeft: 12, paddingBottom: 0, paddingRight: 0, width: 45, height: 45)
    ...
    @objc func handleDiscard(){
        let alertVC = UIAlertController(title: nil , message: "Do you want to discard this post?", preferredStyle: .actionSheet)
...
//        present(navigationController, animated: true, completion: nil)
    ...
    @objc func handlePost(){
        if selectedImages.count <= 5{
            ...
            self.toast = SwiftToast(text: "You can post maximum 5 photos at a time!")
            self.present(self.toast, animated: true)
            return
        }
    }
...
//            selectedImages.removeAll()
            ...
            config.wordings.libraryTitle = "Camera"
...
//                        self.navigationController?.popViewController(animated: true)
            ...
            let titleLabel = FLabel(backgroundColor: UIColor.clear, text: "Gallery", font: UIFont.boldSystemFont(ofSize: 16), textAlignment: .center, textColor: .white)
...
extension CameraVC: UIPickerViewDelegate, UIPickerViewDataSource{
