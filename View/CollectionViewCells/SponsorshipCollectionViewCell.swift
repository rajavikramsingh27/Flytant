//
//  SponsorshipCollectionViewCell.swift
//  Flytant
//
...
class SponsorshipCollectionViewCell: UICollectionViewCell, UICollectionViewDelegate, UICollectionViewDelegateFlowLayout, UICollectionViewDataSource {
...
//    MARK: - Views
    ...
    let reviewLabel = FLabel(backgroundColor: UIColor.clear, text: "", font: UIFont(name: "RoundedMplus1c-Medium", size: 14)!, textAlignment: .center, textColor: UIColor.white)
    ...
    private func configureViews(){
        ...
        bgImageView.anchor(top: bgView.topAnchor, left: bgView.leftAnchor, bottom: nil, right: bgView.rightAnchor, paddingTop: 0, paddingLeft: 0, paddingBottom: 0, paddingRight: 0, width: 0, height: 180)
        ...
        appliedLabel.anchor(top: appliedIV.topAnchor, left: appliedIV.leftAnchor, bottom: appliedIV.bottomAnchor, right: appliedIV.rightAnchor, paddingTop: 0, paddingLeft: 0, paddingBottom: 0, paddingRight: 0, width: 0, height: 0)
                ...
                reviewIV.anchor(top: appliedIV.bottomAnchor, left: nil, bottom: nil, right: bgImageView.rightAnchor, paddingTop: 8, paddingLeft: 0, paddingBottom: 0, paddingRight: 0, width: 120, height: 24)
                bgImageView.addSubview(reviewLabel)
                reviewLabel.anchor(top: reviewIV.topAnchor, left: reviewIV.leftAnchor, bottom: reviewIV.bottomAnchor, right: reviewIV.rightAnchor, paddingTop: 0, paddingLeft: 0, paddingBottom: 0, paddingRight: 0, width: 0, height: 0)
