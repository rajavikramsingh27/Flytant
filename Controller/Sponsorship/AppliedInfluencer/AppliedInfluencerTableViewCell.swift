//
//  AppliedInfluencerTableViewCell.swift
//  Flytant
...
class AppliedInfluencerTableViewCell: UITableViewCell {
    ...
    override func updateConstraints() {
       ...
       AppliedInfluencerChatButton.anchor(top: AppliedInfluencerName.bottomAnchor, left: AppliedInfluencerName.rightAnchor, bottom: nil, right: rightAnchor, paddingTop: 10, paddingLeft: 0, paddingBottom: 0, paddingRight: 60, width: 20, height: 20)
...
extension AppliedInfluencerTableViewCell : UICollectionViewDataSource,UICollectionViewDelegate,UICollectionViewDelegateFlowLayout{
